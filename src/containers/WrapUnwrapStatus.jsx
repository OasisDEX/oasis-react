...
export class WrapUnwrapStatusWrapper extends PureComponent {
  render() {
    ...
    switch (this.props.type) {
      case WRAP_STATUS_VIEW_TYPE_UNWRAP: return activeTokenUnwrapStatus    ? (<UnwrapStatus/>)  : null;
      case WRAP_STATUS_VIEW_TYPE_WRAP:   return activeTokenWrapStatus ? (<WrapStatus/>)    : null;
    }
