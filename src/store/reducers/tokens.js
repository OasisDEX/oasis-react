...
import {
  BASE_TOKENS,
  QUOTE_TOKENS, TOKEN_1ST, TOKEN_AUGUR, TOKEN_BAT,
  TOKEN_DAI,
  TOKEN_DIGIX, TOKEN_GNOSIS, TOKEN_GUP, TOKEN_ICONOMI,
  TOKEN_MAKER, TOKEN_MLN, TOKEN_NMR, TOKEN_PLUTON, TOKEN_RHOC,
  TOKEN_SAI, TOKEN_SINGULARDTV, TOKEN_TIME, TOKEN_VSL,
  TOKEN_WRAPPED_ETH, TOKEN_WRAPPED_GNT,
} from '../../constants';
...
const initialState = Immutable.fromJS({
  ...
  tokenSpecs: {
    ...
    [TOKEN_GNOSIS]: { precision: 18, format: '0,0.00[0000000000000000]' },
